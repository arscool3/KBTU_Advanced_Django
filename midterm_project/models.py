...
class Product(Base):
    ...
    # comment: Mapped['Comment'] = relationship(back_populates='product')
...
#     text: Mapped[str] = mapped_column(String(550))
#     rating: Mapped[float]
#     product_id: Mapped[int] = mapped_column(ForeignKey('products.id'))

#     product: Mapped[Product] = relationship(back_populates='comment')
