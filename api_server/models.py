...
from schemas.model_schemas import Song, Album
...
user_song_table = sqlalchemy.table(
    'user_song_table',
    ModelBase.metadata,
...
class User(IdBase, ModelBase):
    ...
    email: Mapped[str]
    listened: Mapped[list[Song]] = relationship(secondary=user_song_table, back_populates="users")
